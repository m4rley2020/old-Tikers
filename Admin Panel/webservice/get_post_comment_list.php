<?php
	...
	if($_REQUEST['user_id'] != '' && $_REQUEST['post_id'] != '' && $_REQUEST['start'] != '' && $_REQUEST['start'] >= 0)
	{
		$post_id = $_REQUEST['post_id'];
		$post_start_limit = $_REQUEST['start'];
		$get_query2 = "select * from post_comment where post_id='".$post_id."' order by id desc limit $post_start_limit,10";
