<?php
	...
	if($_REQUEST['store_id'] != '' && $_REQUEST['post_id'] && $_REQUEST['start'] != '' && $_REQUEST['start'] >= 0)
	{
		$post_start_limit = $_REQUEST['start'];
		$get_query = "select * from post_like where post_id = '".$_REQUEST['post_id']."' limit $post_start_limit,10";
