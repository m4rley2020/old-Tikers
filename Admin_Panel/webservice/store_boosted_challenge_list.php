<?php
	...
	if($_REQUEST['store_id'] != '' && $_REQUEST['start'] != '' && $_REQUEST['start'] >= 0)
	{
		...
		$get_query2 = "select * from store_challenges where store_id = '".$_REQUEST['store_id']."' and is_deleted = 0 and is_approved = 1 and is_boost = 1 order by id desc limit $post_start_limit,10 ";
