<?php
	...
	if($_REQUEST['user_id'] != '' && $_REQUEST['date_time'])
	{ 
		...
		$get_query1 = "select * from store_challenge_complete_by_user where user_id in (".$follow_uid.") and status = 1 and (add_date BETWEEN '".$date_time2."' AND '".$date_time1."')  order by add_date desc";
