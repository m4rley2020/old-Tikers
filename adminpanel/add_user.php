                                ...
                                <form action="add_user.php" method="post" name="frm" enctype="multipart/form-data" onSubmit="javascript:return keshav_check();" class="form-horizontal row-border" id="validate-1" novalidate="novalidate">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control required" name="user_type" id="user_type">
                                                ...
                                                <option value="User" <?php if ($user_type != "" && in_array("User", $tmp_cmb_array1)) {
                                                                            echo 'selected="selected"';
                                                                        } ?>>User</option>
                                                <option value="Store" <?php if ($user_type != "" && in_array("Store", $tmp_cmb_array1)) {
                                                                            echo 'selected="selected"';
                                                                        } ?>>Store</option>
                                                <option value="Famous" <?php if ($user_type != "" && in_array("Famous", $tmp_cmb_array1)) {
                                                                            echo 'selected="selected"';
                                                                        } ?>>Famous</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9"><?php $tmp_cmb_array10 = explode(",", $is_verified); ?>
                                            <input class="" <?php if ($is_verified != "" && in_array("1", $tmp_cmb_array10)) {
                                                                echo 'checked="checked"';
                                                            } ?> name="is_verified[]" type="checkbox" id="is_verified[]" value="1">
                                        </div>
                                    </div>
