...
$sel= "select * from store_challenge_complete_by_user" ;
                    ...
                    <div class="col-md-12">
                        <div class="portlet box blue">
						  ...
						  <? $count=0; 
							 ...
							 {  
								$count++;
								 $user_name = GetValue('user','username','id',stripslashes($get->user_id));
								 $challenge_name = GetValue('store_challenges','name','id',stripslashes($get->challenge_id));
								 $store_name = GetValue('store','name','id',stripslashes($get->store_id));
						 ?>	 
							 <tr>
							  <td>
							 ...
							 <td><?=$count;?>.</td>
							  ...
							  <td > <strong> <? echo $user_name; ?></strong></td>
							  <td > <strong> <? echo $challenge_name; ?></strong></td>
							  <td > <strong> <? echo $store_name; ?></strong></td>
								<td > <strong> <? echo stripslashes($get->amount); ?></strong></td>
								<td nowrap>				 
		<a class="btn mini blue" href="#" onClick="window.location.href='edit_completed_challenge.php?id=<?php echo ($get->id); ?>&mode=edit'"><i class="fa fa-pencil"></i></a> 
                <a class="btn mini red" href="#" onClick="deleteconfirm('Are you sure you want to delete this <?=$pagetitle;?>?. \n','edit_completed_challenge.php?id=<?php echo($get->id); ?>&mode=delete');"><i class="fa fa-trash-o"></i></a>    
