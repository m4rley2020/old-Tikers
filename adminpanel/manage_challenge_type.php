            ...
            <div class="container"> <!-- Start : Inner Page container -->
                ...
                <div class="alert alert-danger show">
                        <button class="close" data-dismiss="alert"></button>
                          ...
                          <?
                                    if($_GET["msg"]==1)
                                            echo "Challenge Type Added Successfully.";
                                    elseif($_GET["msg"]==2)
                                            echo "Challenge Type Updated Successfully.";
                                    elseif($_GET["msg"]==3)
                                            echo "Challenge Type Deleted Successfully.";
                                    elseif($_GET["msg"]==4)
                                            echo "Challenge Type with this name is already Exist.";	
                                    elseif($_GET["msg"]==5)
                                            echo "This Challenge Type is in use. You can not delete this Challenge Type.";	
                ...
                <div class="row">
                    <div class="col-md-12">
						...
						<th width="25px">No.</th><th>Name</th><th>Image</th><th>Is Hot?</th>
                                                <th>Actions</th>                                               
                                                </tr>
                                                </thead>
                                        <tbody>
