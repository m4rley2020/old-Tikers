...
if(isset($_REQUEST['btnDelete']))
{
	...
	for($i = 1;$i <= $count1;$i++)
	{
		...
		{
			$query = "DELETE FROM  store_code where id=".$_REQUEST[$pid];
		}
...
$sel= "select * from store_code where id like '".$_GET["order"]."%' order by id" ;$result=$prs_pageing->number_pageing($sel,20000,10,'N','Y','',$db);
            ...
            <div class="container"> <!-- Start : Inner Page container -->
                ...
                <div class="alert alert-danger show">
                        <button class="close" data-dismiss="alert"></button>
                          ...
                          <?
                                    ...
                                    elseif($_GET["msg"]==4)
                                            echo "Code with this name is already Exist.";	
                                    elseif($_GET["msg"]==5)
                                            echo "This Code is in use. You can not delete this Code.";
									elseif($_GET["msg"]==6)
                ...
                <div class="row">
                    <div class="col-md-12">
						...
						<th width="25px">No.</th><th>Store Name</th><th>Code</th><th>Is used?</th><th>points</th>
                                                <th>Actions</th>                                               
                                                </tr>
                                                </thead>
                                        <tbody>
						 ...
						 ?>	 
							 ...
							 <td><?=$count;?>.</td>
							  ...
							  <td > <strong> <?php echo stripslashes(GetValue('store','name','id',$get->store_id,$db)); ?></strong></td>
							  <td > <strong> <?php echo stripslashes($get->code); ?></strong></td>
							  <td > <strong> <?php echo stripslashes($get->is_used); ?></strong></td>
                              <td > <strong> <?php echo stripslashes($get->points); ?></strong></td><td nowrap>				 
		<a class="btn mini blue" href="#" onClick="window.location.href='add_store_code.php?id=<?php echo ($get->id); ?>&mode=edit'"><i class="fa fa-pencil"></i></a> 
                <a class="btn mini red" href="#" onClick="deleteconfirm('Are you sure you want to delete this <?=$pagetitle;?>?. \n','add_store_code.php?id=<?php echo($get->id); ?>&mode=delete');"><i class="fa fa-trash-o"></i></a>    
                ...
                <?php } ?>	
				 ...
				 <input style="margin-right:7px;" type="button" name="button2" id="button2" value="ADD NEW"  onclick="location.href='add_store_code.php?mode=add'" class="btn green pull-left" />
                                    &nbsp; 
...
<script>
    ...
    function chkDelete()
    {
            return confirm("Are you sure that you want to delete the selected Code.");
    }
</script>    
