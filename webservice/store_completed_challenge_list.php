<?php
	...
	{ 
		...
		$get_query_res1 =   mysqli_query($get_query1)or die(mysqli_error());
		if(mysqli_num_rows($get_query_res1)>0)
		{
			while($get_query_date1 = mysqli_fetch_array($get_query_res1))
			{
				...
				$get_challenge_res = mysqli_query($get_challenge) or die(mysqli_error());
				$get_challenge_row = mysqli_fetch_array($get_challenge_res);
				...
				$get_user_res = mysqli_query($get_user) or die(mysqli_error());
