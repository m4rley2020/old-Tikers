...
if (isset($_REQUEST['btnDelete'])) {
    ...
    for ($i = 1; $i <= $count1; $i++) {
        ...
        if (isset($_REQUEST[$chk])) {
            $query = "DELETE FROM  in_app_store where id=" . $_REQUEST[$pid];
        }
...
$LeftLinkSection = 1;
$pagetitle = "In-App Store";
$sel = "select * from in_app_store where name like '" . $_GET["order"] . "%' order by name";
...
<body>
                    ...
                    <div class="alert alert-danger show">
                        ...
                        <span style="color:#CC6600;">
                            <?
                                    ...
                                    elseif($_GET["msg"]==4)
                                            echo "Package with this name is already Exist.";	
                                    elseif($_GET["msg"]==5)
                                            echo "This Package is in use. You can not delete this Package.";	
                                    ...
                                    <form name="frmNewsList" method="post" action="">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="photo">
                                                            <?php if ($get->store_image != "" && file_exists('../app_store_image/' . $get->store_image)) { ?>
                                                                <img src="<?php echo '../app_store_image/' . $get->store_image; ?>" width="125" border="0" hspace="8" />
                                                                <?php } ?>&nbsp;
                                                        </td>
                                                        <td> <?php echo $get->cost; ?> </td>
                                                        <td nowrap>
                                                            <a class="btn mini blue" href="#" onClick="window.location.href='add_in_app_store.php?id=<?php echo ($get->id); ?>&mode=edit'"><i class="fa fa-pencil"></i></a>
                                                            <a class="btn mini red" href="#" onClick="deleteconfirm('Are you sure you want to delete this <?= $pagetitle; ?>?. \n','add_in_app_store.php?id=<?php echo ($get->id); ?>&mode=delete');"><i class="fa fa-trash-o"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input style="margin-right:7px;" type="button" name="button2" id="button2" value="ADD NEW" onclick="location.href='add_in_app_store.php?mode=add'" class="btn green pull-left" />
                                                &nbsp;
    ...
    <script>
        ...
        function chkDelete() {
            return confirm("Are you sure that you want to delete the selected Package.");
        }
    </script>
