<?php
	...
	if($_REQUEST['store_id'] != '' && $_REQUEST['challenge_type_id'] != '' && $_REQUEST['name'] != '' && $_REQUEST['description'] != '' && $_REQUEST['location'] != '' && $_REQUEST['lattitude'] != '' && $_REQUEST['longitude'] != '' && $_REQUEST['gender'] != '')
	{
