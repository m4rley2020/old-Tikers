...
function send_notification($sender_id,$reciver_id,$type,$message)
{
 ...
 function insert_notification($sender_id,$reciver_id,$type,$message)
 {
	...
	mysql_query($add_noti) or die(mysql_error());
 }
 
 
 function insert_notification2($sender_id,$reciver_id,$type,$message,$post_id)
 {
 	$add_noti = "insert into notification set sender_id = '".$sender_id."', receiver_id = '".$reciver_id."', type = '".$type."', 
						message = '".$message."', is_read = 0, post_id = '".$post_id."', created_date = now() ";
