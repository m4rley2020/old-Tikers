                ...
                <div class="row">
                    ...
                    <div class="form-group">
                            <label class="col-md-3 control-label">
                             ...
                             <div class="col-md-9">
                        <select class="form-control required" name="store_id" id="store_id" ><option value="-" <?php if($store_id == '-'){ ?>selected="selected"<?php } ?>>Please Select</option><?php $tmp_cmb_array1 = explode(",",$store_id); ?><?php										
											...
											{	
											?>
											<option value="<?=$add_row1['id']?>" <?php if($store_id!="" && in_array($add_row1['id'],$tmp_cmb_array1)){ echo 'selected="selected"'; } ?>><?=$add_row1['name']." ";?></option>
											<?php
											}										
											?> </select>
