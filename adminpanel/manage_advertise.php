            ...
            <div class="container"> <!-- Start : Inner Page container -->
                ...
                <div class="alert alert-danger show">
                        <button class="close" data-dismiss="alert"></button>
                          ...
                          <?
                                    if($_GET["msg"]==1)
                                            echo "Advertise Added Successfully.";
                                    elseif($_GET["msg"]==2)
                                            echo "Advertise Updated Successfully.";
                                    elseif($_GET["msg"]==3)
                                            echo "Advertise Deleted Successfully.";
                                    elseif($_GET["msg"]==4)
                                            echo "Advertise with this name is already Exist.";	
                                    elseif($_GET["msg"]==5)
                                            echo "This Advertise is in use. You can not delete this Advertise.";	
                ...
                <div class="row">
                    <div class="col-md-12">
						...
						<th width="25px">No.</th><th>Title</th><th>Image</th><th>Message</th>
                                                <th>Actions</th>                                               
                                                </tr>
                                                </thead>
                                        <tbody>
...
<script>
    ...
    function chkDelete()
    {
            return confirm("Are you sure that you want to delete the selected Advertise.");
    }
</script>    
