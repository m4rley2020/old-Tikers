...
$LeftLinkSection = 1;
$pagetitle = "Package";
$sel = "select * from package where name like '" . $_GET["order"] . "%' order by name";
                                    ...
                                    <form name="frmNewsList" method="post" action="">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="photo">
                                                            <?php if ($get->package_image != "" && file_exists('../package_image/' . $get->package_image)) { ?>
                                                                <img src="<?php echo '../package_image/' . $get->package_image; ?>" width="125" border="0" hspace="8" />
                                                                <?php } ?>&nbsp;
                                                        </td>
                                                        <td> <?php echo $get->bonus_percentage; ?> </td>
                                                        <td nowrap>
                                                            <a class="btn mini blue" href="#" onClick="window.location.href='add_package.php?id=<?php echo ($get->id); ?>&mode=edit'"><i class="fa fa-pencil"></i></a>
                                                            <a class="btn mini red" href="#" onClick="deleteconfirm('Are you sure you want to delete this <?= $pagetitle; ?>?. \n','add_package.php?id=<?php echo ($get->id); ?>&mode=delete');"><i class="fa fa-trash-o"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input style="margin-right:7px;" type="button" name="button2" id="button2" value="ADD NEW" onclick="location.href='add_package.php?mode=add'" class="btn green pull-left" />
                                                &nbsp;
