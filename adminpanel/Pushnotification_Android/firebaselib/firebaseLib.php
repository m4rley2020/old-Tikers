...
class FirebaseLib implements FirebaseInterface
{
	...
	public function push_noti($path,$registatoin_ids,$message, $GOOGLE_API_KEY)
    {
      return $this->_writePushData($path,$registatoin_ids, $message, $GOOGLE_API_KEY);
    }	
    /**
    ...
    private function _writePushData($path,$key, $msg,$GOOGLE_API_KEY)
    {
    	$fields = array(
